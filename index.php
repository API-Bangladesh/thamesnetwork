	...
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
			...
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/slider4.jpg);">
			    	<div class="text">
                            ...
                            <h1 class="display-3 text-white mb-md-4">start from  £10 Full Fiber Connection</h1>
                            <a href="" class="btn btn-primary py-md-3 px-md-5 mt-2">Call for Order  +4402081236644</a>
                        </div>
			</div><!-- /.item -->
		...
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/slider1.jpg);">
				...
				<div class="text">
                            <h4 class="text-white text-uppercase mb-md-3">Free Tree for  Connection </h4>
                            <h1 class="display-3 text-white mb-md-4">Start from  £10 Full Fiber Connection.</h1>
                            <a href="" style="color:#003366;font-size:16px;"class="btn btn-primary py-md-3 px-md-5 mt-2">Call for Order +4402081236644</a>
                        </div>
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
...
<div class="trustpilot-widget" data-locale="en-GB" data-template-id="5419b6a8b0d04a076446a9ad" data-businessunit-id="61941a00c6072dd796ab14ad" data-style-height="24px" data-style-width="100%" data-theme="light" data-min-review-count="10" data-without-reviews-preferred-string-id="1" data-style-alignment="center">
		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">£10 a month then £15 for one year contract limited time only , Ends 30 th April.</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">All of our plans are full fibre and come with unlimited data</h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
                ...
                <div class="row">                   
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="feature-item mb-30px">
                            ...
                            <p>Thamesoptic is a Internet Communications Ltd is a private broadband internet service provider with 12 years of experience.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="feature-item mb-30px">
                            ...
                            <p>Full Fibre is our most reliable and fastest ever broadband. Built to power busy online homes it delivers incredible speeds up to 500Mb.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="feature-item mb-30px">
                            ...
                            <p>Calls of up to an hour to UK landlines beginning with 01, 02, 03, 0845 and 0870 numbers made Monday-Friday 7pm to 7am and any time Saturday or Sunday</p>
                        </div>
                    </div>
                </div>
            </div>
...
<p style="text-align:center">Chose your best Package Free Tree for a Connection<p>
