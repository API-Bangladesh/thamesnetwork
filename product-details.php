...
<?php if($row['productAvailability']=='In Stock'){?>
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i>Order</a>
													<?php } else {?>
							...
							<div class="product-social-link m-t-20 text-right">
								...
								<div class="social-icons">
						            <ul class="list-inline">
						                <li><a class="fa fa-facebook" href="https://www.facebook.com/Onlinebigshopping/"></a></li>
						                <li><a class="fa fa-twitter" href="https://twitter.com/thamesoptic"></a></li>
						                <li><a class="fa fa-linkedin" href="https://www.linkedin.com/in/thamesoptic"></a></li>
						                <li><a class="fa fa-instagram" href="https://www.instagram.com/thamesoptic/"></a></li>
						                <li><a class="fa fa-pinterest" href="https://www.pinterest.com/thamesoptic"></a></li>
						            </ul><!-- /.social-icons -->
						        </div>
							</div>
			...
			<div class="product-price">	
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">Order</a>
