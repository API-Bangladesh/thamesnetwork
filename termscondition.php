...
<p style="text-align:left;font-size: 15px; margin-top: 20px;  margin-bottom: 100px;margin-right: 150px;
  margin-left: 80px; ">
	<b>1.1. The following terms and expressions in these Terms shall have the meanings set out below:</b><br>
The one-time fee for connecting to Thamesoptic's services that is included in a customer's first invoice, as specified on an order, and/or as described in the Guide to Charges and Fees for Business Clients is referred to as the "Activation Charge."
"Activation Steps" refers to the procedures outlined in Article 
13.6 that must be followed by a Customer's new and previous telephone network providers in order to transfer the Customer's phone number to the new provider's network.
Any additional telephone plan, additional static IP address(es), and/or supplemental services and features from time to time are referred to as "Additional Service(s)".<br>

In connection with the Business Broadband Service and/or Telephone Service, Thamesoptic may from time to time offer "Extra Service(s)," which includes any Additional Telephone Plan, Additional Static IP Address(es), and/or supplemental Services and features.<br>
Any static IP address(es) that Thamesoptic provides to the customer upon the customer's request and that are not included in the customer's monthly package charge are referred to as "Additional Static IP Address(es)".
"Additional Telephone Plans" refers to any supplemental plans that are occasionally offered for the Telephone Service and that the Customer has ordered in addition to the Business Broadband Package that they have selected. They are described as "Call Plans" in Thamesoptic's Guide to Charges & Fees for Business Clients.
The Agreement outlined in Clause 2 is referred to as the "Agreement" in respect to Clause.<br>

“Applicable Law” means any applicable law, statute, bye-law, regulation, order, regulatory policy, guidance, standard or industry code, rule of court or directives or requirements of any government or regulatory body, delegated or subordinate legislation or notice of any government or regulatory body and the common law and the law of equity as from time to time applicable to the parties.<br>
